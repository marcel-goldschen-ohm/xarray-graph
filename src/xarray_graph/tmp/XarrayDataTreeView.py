...
class XarrayDataTreeView(TreeView):
    ...
    def _updateViewOptionsFromModel(self):
        ...
        self._showDetailsColumnAction.setChecked(model.isInfoColumnsVisible())
    ...
    def _updateModelFromViewOptions(self):
        ...
        model.setInfoColumnsVisible(self._showDetailsColumnAction.isChecked())
